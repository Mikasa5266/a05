...
var scenarioPool = []BlindBoxScenario{
	...
	},
	{
		...
		Tags:        []string{"表达", "项目经验"}, Style: "gentle", TimeLimit: 0, Icon: "🎤",
	},
	{
	...
	},
	{
		...
		Tags:        []string{"系统设计", "分析"}, Style: "deep", TimeLimit: 180, Icon: "📊",
	},
	{
	...
	},
	{
		...
		Tags:        []string{"表达", "教学能力"}, Style: "gentle", TimeLimit: 0, Icon: "🔄",
	},
	// === High Pressure ===
	{
	...
	// === Extreme Pressure ===
	{
		ID: "final_boss", Name: "终极 Boss", Pressure: "extreme",
...
要求：
1. 题目必须贴合场景主题和压力等级。
2. 如果是高压或极限场景，题目应该具有挑战性、需要深入思考、带有适度压迫感。
