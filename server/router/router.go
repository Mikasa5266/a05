...
func SetupRouter(aiService aidomain.AIFacade) *gin.Engine {
	...
	api := router.Group("/api/v1")
	{
		...
		protected.Use(middleware.Auth())
		{
			...
			protected.GET("/question-bank/meta", handler.GetQuestionBankMeta)
			protected.GET("/question-bank/options", handler.GetQuestionBankOptions)
			protected.GET("/question-bank/questions", handler.ListQuestionBankQuestions)
			protected.GET("/question-bank/lists", handler.GetQuestionBankLists)
			protected.GET("/question-bank/random", handler.DrawQuestionBankQuestion)
			protected.POST("/question-bank/answer", handler.SubmitQuestionBankAnswer)
			protected.GET("/question-bank/points/:point/summary", handler.GetQuestionBankPointSummary)
			protected.GET("/question-bank/questions/:id/solution", handler.GetQuestionBankSolution)
			protected.POST("/question-bank/assessment/start", handler.StartQuestionBankAssessment)
			protected.POST("/question-bank/assessment/answer", handler.SubmitQuestionBankAssessmentAnswer)
			protected.POST("/question-bank/assessment/:id/complete", handler.CompleteQuestionBankAssessment)
