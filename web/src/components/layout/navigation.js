...
export const portalNavMap = {
  student: [
    { name: "\u4e2a\u4eba\u9996\u9875", href: "/student/dashboard", icon: LayoutDashboard },
    { name: "\u6a21\u62df\u9762\u8bd5", href: "/student/interview", icon: Video },
    { name: "\u771f\u4eba\u9762\u8bd5", href: "/interview/live/workbench", icon: ClipboardList },
    { name: "\u5237\u9898\u4e2d\u5fc3", href: "/student/question-bank", icon: BookOpen },
    { name: "\u6210\u957f\u4e2d\u5fc3", href: "/student/growth", icon: TrendingUp },
    { name: "\u7b80\u5386\u5206\u6790", href: "/student/resume", icon: FileText },
  ...
  enterprise: [
    ...
    { name: "HR \u9762\u8bd5\u53f0", href: "/enterprise/hr-panel", icon: Video },
